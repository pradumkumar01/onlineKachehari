...
class LegalDocumentAttestation extends StatefulWidget {
  const LegalDocumentAttestation({super.key});

  @override
  State<LegalDocumentAttestation> createState() =>
      _LegalDocumentAttestationState();
}

class _LegalDocumentAttestationState extends State<LegalDocumentAttestation> {
  bool _isHindi = false;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(
            translate('Legal Document Attestation', 'कानूनी दस्तावेज़ सत्यापन'),
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  Text(
                    translate('What is Legal Document Attestation?',
                  ...
                  Text(
                    translate(
                      'Legal document attestation involves verifying the authenticity of your documents by a legal expert.',
                      'कानूनी दस्तावेज़ सत्यापन में आपके दस्तावेज़ों की प्रामाणिकता की एक कानूनी विशेषज्ञ द्वारा पुष्टि शामिल है।',
                    ),
            ...
            // Steps of Legal Document Attestation Process
            Text(
              translate('Legal Document Attestation Process',
            ...
            _buildAttestationStep(
                stepNumber: '3',
                description: translate(
                    'Providing attestation.', 'सत्यापन प्रदान करना।')),

            const SizedBox(height: 20),

            // Action buttons wrapped in cards for a more attractive look
            _buildActionButton(
              label: translate('Request Document Attestation',
  ...
  // Helper method to build each step in the legal document attestation process
  Widget _buildAttestationStep(
