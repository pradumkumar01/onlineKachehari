...
class LegalDocumentCertification extends StatefulWidget {
  const LegalDocumentCertification({super.key});

  @override
  State<LegalDocumentCertification> createState() =>
      _LegalDocumentCertificationState();
}

class _LegalDocumentCertificationState
    extends State<LegalDocumentCertification> {
  bool _isHindi = false;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(
            translate(
                'Legal Document Certification', 'कानूनी दस्तावेज़ प्रमाणीकरण'),
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  Text(
                    translate('What is Legal Document Certification?',
                        'कानूनी दस्तावेज़ प्रमाणीकरण क्या है?'),
                  ...
                  Text(
                    translate(
                      'Legal document certification involves verifying the authenticity of your documents by a legal expert.',
                      'कानूनी दस्तावेज़ प्रमाणीकरण में आपके दस्तावेज़ों की प्रामाणिकता की एक कानूनी विशेषज्ञ द्वारा पुष्टि शामिल है।',
                    ),
            ...
            // Steps of Legal Document Certification Process
            Text(
              translate('Legal Document Certification Process',
                  'कानूनी दस्तावेज़ प्रमाणीकरण की प्रक्रिया'),
              style: const TextStyle(
                fontSize: 22,
                fontWeight: FontWeight.bold,
                color: Colors.deepPurple,
            ...
            _buildCertificationStep(
                stepNumber: '2',
                description: translate('Verification by a legal expert.',
                    'एक कानूनी विशेषज्ञ द्वारा सत्यापन।')),
            _buildCertificationStep(
                stepNumber: '3',
                description: translate(
                    'Providing certification.', 'प्रमाणीकरण प्रदान करना।')),

            const SizedBox(height: 20),

            // Action buttons wrapped in cards for a more attractive look
            _buildActionButton(
              label: translate('Request Document Certification',
                  'दस्तावेज़ प्रमाणीकरण का अनुरोध करें'),
  ...
  // Helper method to build each step in the legal document certification process
