...
class LegalDocumentRegistration extends StatefulWidget {
  const LegalDocumentRegistration({super.key});

  @override
  State<LegalDocumentRegistration> createState() =>
      _LegalDocumentRegistrationState();
}

class _LegalDocumentRegistrationState extends State<LegalDocumentRegistration> {
  bool _isHindi = false;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(
            translate(
                'Legal Document Registration', 'कानूनी दस्तावेज़ पंजीकरण'),
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  Text(
                    translate('What is Legal Document Registration?',
                        'कानूनी दस्तावेज़ पंजीकरण क्या है?'),
                  ...
                  Text(
                    translate(
                      'Legal document registration involves officially recording your documents with a legal authority.',
                      'कानूनी दस्तावेज़ पंजीकरण में आपके दस्तावेज़ों को एक कानूनी प्राधिकरण के साथ आधिकारिक रूप से दर्ज करना शामिल है।',
                    ),
            ...
            // Steps of Legal Document Registration Process
            Text(
              translate('Legal Document Registration Process',
                  'कानूनी दस्तावेज़ पंजीकरण की प्रक्रिया'),
              style: const TextStyle(
                fontSize: 22,
                fontWeight: FontWeight.bold,
                color: Colors.deepPurple,
            ...
            _buildRegistrationStep(
                stepNumber: '3',
                description:
                    translate('Official registration.', 'आधिकारिक पंजीकरण।')),

            const SizedBox(height: 20),

            // Action buttons wrapped in cards for a more attractive look
            _buildActionButton(
              label: translate('Request Document Registration',
                  'दस्तावेज़ पंजीकरण का अनुरोध करें'),
  ...
  // Helper method to build each step in the legal document registration process
